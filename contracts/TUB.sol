...
contract TubToken is IERC20, Ownable {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "TUB: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "TUB: decreased allowance below zero");
        unchecked {
    ...
    function setFeePercentage(uint8 taxPercent_) external onlyOwner {
        require(taxPercent_ <= 1500, "TUB: transaction fee percentage exceeds 15   %");
